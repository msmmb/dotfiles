# Generated by Powerlevel10k configuration wizard on 2022-09-18 at 09:16a CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # ?42 if have untracked files. It's really a question mark, your fontzz isn't broken.
  ...
  # Context format when running with privileges: ﮊ bold user.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='ﮊ %B%n'
